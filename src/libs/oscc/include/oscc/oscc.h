...
/**
 * @brief Check if CAN data is available.
 *
 ...
 *        steering module.
 *
 * @param [in] angle - Requested steering wheel angle (deg)
 * 			in the range [-550, 550].
 *
 * @param [in] velocity - Requested steering wheel max rate (deg/sec)
  *
 * @return OSCC_ERROR or OSCC_OK
 *
 */
...
/**
 * @brief Register callback function to be called when steering angle report
 *        received from steering module.
 *
 * @param [in] callback - Pointer to callback function to be called when
 *                        steering report received from steering module.
