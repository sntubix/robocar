...
#ifndef ROBOCAR_DRIVERS_LIDAR_OUSTER_COMPONENT_H
#define ROBOCAR_DRIVERS_LIDAR_OUSTER_COMPONENT_H
...
namespace robocar::drivers::lidar
{
	...
	class OusterComponent : public robocar::Component
	{
	public:
		OusterComponent(const robocar::Params &params);
...
#endif // ROBOCAR_DRIVERS_LIDAR_OUSTER_COMPONENT_H