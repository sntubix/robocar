...
#ifndef ROBOCAR_CONTROL_CONTROL_COMPONENT_H
#define ROBOCAR_CONTROL_CONTROL_COMPONENT_H
...
namespace robocar
{
	namespace control
	{
		...
		class ControlComponent : public robocar::Component
		{
		public:
			ControlComponent(const robocar::Params &params);
...
#endif // ROBOCAR_CONTROL_CONTROL_COMPONENT_H
