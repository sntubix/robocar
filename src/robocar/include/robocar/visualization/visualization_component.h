...
#ifndef ROBOCAR_VISUALIZATION_VISUALIZATION_COMPONENT_H
#define ROBOCAR_VISUALIZATION_VISUALIZATION_COMPONENT_H
...
{
	class VisualizationComponent : public robocar::Component
	{
	public:
		VisualizationComponent(const robocar::Params &params);
...
#endif // ROBOCAR_VISUALIZATION_VISUALIZATION_COMPONENT_H