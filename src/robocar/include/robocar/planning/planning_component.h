...
#ifndef ROBOCAR_PLANNING_PLANNING_COMPONENT_H
#define ROBOCAR_PLANNING_PLANNING_COMPONENT_H

#include "robocar/core/robocar.h"
#include "robocar/planning/mppi/mppi.h"
...
namespace robocar
{
	namespace planning
	{
		...
		class PlanningComponent : public robocar::Component
		{
		public:
			PlanningComponent(const robocar::Params &params);
...
#endif // ROBOCAR_PLANNING_PLANNING_COMPONENT_H