...
#ifndef ROBOCAR_MAP_MAP_COMPONENT_H
#define ROBOCAR_MAP_MAP_COMPONENT_H
...
namespace robocar
{
	namespace map
	{
		...
		class MapComponent : public robocar::Component
		{
		public:
			MapComponent(const robocar::Params &params);
...
#endif // ROBOCAR_MAP_MAP_COMPONENT_H