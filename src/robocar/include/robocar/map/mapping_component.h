...
#ifndef ROBOCAR_MAP_MAPPING_COMPONENT_H
#define ROBOCAR_MAP_MAPPING_COMPONENT_H
...
namespace robocar
{
	namespace map
	{
		...
		class MappingComponent : public robocar::Component
		{
		public:
			MappingComponent(const robocar::Params &params);
...
#endif // ROBOCAR_MAP_MAPPING_COMPONENT_H