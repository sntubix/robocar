...
#ifndef ROBOCAR_PERCEPTION_LIDAR_PERCEPTION_COMPONENT_H
#define ROBOCAR_PERCEPTION_LIDAR_PERCEPTION_COMPONENT_H
...
namespace robocar::perception
{
	class LidarPerceptionComponent : public robocar::Component
	{
	public:
		LidarPerceptionComponent(const robocar::Params &params);
...
#endif // ROBOCAR_PERCEPTION_LIDAR_PERCEPTION_COMPONENT_H