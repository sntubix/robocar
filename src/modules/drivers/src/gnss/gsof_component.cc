    ...
    if (_connected)
    {
        if (read_packet())
        {
            ...
            std::cout << "lat: " << _gnss.lat() << "\n"
                      << "lon: " << _gnss.lon() << "\n"
                      << "altitude: " << _gnss.altitude() << "\n"
                      << "velocity: " << _gnss.velocity() << "\n"
                      << "heading: " << _gnss.heading() << "\n"
                      << "accel_x: " << _gnss.accel_x() << "\n"
                      << "accel_y: " << _gnss.accel_y() << "\n"
                      << "sigma_x: " << _gnss.sigma_x() << "\n"
                      << "sigma_y: " << _gnss.sigma_y() << "\n"
                      << std::endl;
            */
        }
    }
